...
$products = mysqli_query($con, "SELECT * FROM `product` WHERE kids='yes' LIMIT 14242434242424 OFFSET 12");
...
?>
          ...
          <div class="pgbtn">
            <button onclick="window.location.href='kidsclothes.php'">1</button>
            <button onclick="window.location.href='kidsclothes2.php'">&#8594;</button>
          </div>
      </div>
