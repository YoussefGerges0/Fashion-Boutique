...
$products = mysqli_query($con, "SELECT * FROM `product` WHERE men='yes' LIMIT 14242434242424 OFFSET 24");
...
?>
          ...
          <div class="pgbtn">
            <button onclick="window.location.href='menclothes.php'">1</button>
            <button onclick="window.location.href='menclothes2.php'">2</button>
            <button onclick="window.location.href='menclothes3.php'">&#8594;</button>
          </div>
